                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="post post-grid rounded bordered">
                            <div class="thumb top-rounded">
                                <a href="category.html" class="category-badge position-absolute">{{$category['title']}}</a>
                            ...
                            <div class="details">
                                <ul class="meta list-inline mb-0">
                                    <li class="list-inline-item"><a href="#"><img src="{{ asset('frontend') }}/images/other/author-sm.png" class="author" alt="author"/>{{$blog['user_id']}}</a></li>
                                    <li class="list-inline-item">{{$blog['created_at']}}</li>
                                </ul>
                                <h5 class="post-title mb-3 mt-3"><a href="{{ route('blog.single', $blog->slug) }}">{{$blog['title']}}</a></h5>
                            ...
                            <div class="post-bottom clearfix d-flex align-items-center">
                                ...
                                <div class="more-button float-end">
                                    <a href="{{ route('blog.single', $blog->slug) }}"><span class="icon-options"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
