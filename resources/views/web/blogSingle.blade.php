 ...
 @section('content')
	<!-- cover header -->
    <section class="single-cover data-bg-image" data-bg-image="{{asset('uploads/blogs')}}/{{$blog['image']}}">
            ...
            <div class="cover-content post">
                ...
                <div class="post-header">
                    ...
                    <ul class="meta list-inline mb-0">
                        <li class="list-inline-item"><a href="#"><img src="images/other/author-sm.png" class="author" alt="author"/>{{$blog['user_id']}}</a></li>
